...
firebase.initializeApp({
  ...
  databaseURL: "https://friendschat-a7775-default-rtdb.firebaseio.com/",
...
function App() {
  ...
  return (
    <div className="App">
      <header>
       <h1><i class="material-icons"></i>💬Friend Chat</h1>
        <SignOut />
      </header>
...
function ChatRoom() {
  ...
  const sendMessage = async (e) => {
    ...
    await messagesRef.add({
      text: formValue,
      createdAt: firebase.firestore.FieldValue.serverTimestamp(100),
      uid,
      photoURL
    })
